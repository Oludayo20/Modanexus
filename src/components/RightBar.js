...
const RightBar = () => {
  return (
    <div className="hidden xl:inline space-y-2 text-white">
      {/* News */}
      <div className="dark:bg-[#1D2226] py-2.5 rounded-lg space-y-2 w-11/12 overflow-hidden border border-gray-300 dark:border-none">
          ...
          >
            ...
            <div>
              <h5 className="max-w-xs font-medium text-sm truncate pr-10">
                ...
                Exercitationem possimus dicta voluptas ipsum praesentium vel
                magni quidem, quae ullam sapiente soluta consequatur excepturi
                doloribus fugiat delectus hic voluptatem est blanditiis.
              </h5>
              {/* <TimeAgo
